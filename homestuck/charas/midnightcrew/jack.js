...
function spades(){
img.src = "/homestuck/images/spadesslickrefrence.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/hscrop/ssbg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src= "/homestuck/audio/imamemberofthemidnightcrew.mp3";
onloadhaha();
}

function jack(){
img.src = "/homestuck/hscrop/archagentjacknoir.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/hscrop/ajnbg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src= "/homestuck/audio/jokerswild.mp3";
onloadhaha();
}
