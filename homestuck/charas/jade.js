...
function pregame(){
img.src = "/homestuck/hscrop/jadepregame.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/hscrop/jaderoom.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "/homestuck/audio/ogwr.mp3";

onloadhaha();
}

function dream(){
img.src = "/homestuck/hscrop/dreamjade.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/hscrop/dreamjadebg.gif)";
bgstyle.backgroundPosition = "center bottom";
audio.src = "/homestuck/audio/balladofawakening.mp3";
...
bgstyle.backgroundImage = "url(/homestuck/hscrop/jadebg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "";
}