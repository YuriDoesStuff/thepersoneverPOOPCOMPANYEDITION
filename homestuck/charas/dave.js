...
function pregame(){
img.src = "/homestuck/hscrop/davepregame.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/hscrop/davebg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src= "/homestuck/audio/aerosmith.mp3";
onloadhaha();
}


function firstalc(){
img.src = "/homestuck/hscrop/davealcsesh.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/hscrop/davealcbg.gif)";
// url(/homestuck/hscrop/lowasbg.gif)
audio.src = "";
onloadhaha();
}

function dream(){
  img.src = "/homestuck/hscrop/dreamdave.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/hscrop/davedersebg.gif)";
//audio.src = "/homestuck/audio/rangoon.mp3"; REPLACE THIS LATER????
audio.src = "";
onloadhaha();
}
...
bgstyle.backgroundImage = "url(/homestuck/hscrop/davebg2.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "";
}