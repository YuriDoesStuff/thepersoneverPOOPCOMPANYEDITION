...
function pregame(){
windystop();
img.src = "/homestuck/old/hscrop/pregamejohn.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/johnroom2.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "/homestuck/old/audio/showtimepiano.mp3";
otherplaying = 1;
onloadhaha();
}
...
function firstalc(){
windystop();
img.src = "/homestuck/old/hscrop/wiseguyslimesuit.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/lowasbg.gif)";
bgstyle.backgroundPosition = "center bottom";
audio.src = "/homestuck/old/audio/doctorog.mp3";
otherplaying = 1;
onloadhaha();
}
...
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/introbg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "";
otherplaying = 0;
}