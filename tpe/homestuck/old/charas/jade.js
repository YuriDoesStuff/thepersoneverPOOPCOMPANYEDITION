...
function pregame(){
img.src = "/homestuck/old/hscrop/jadepregame.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/jaderoom.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "/homestuck/old/audio/ogwr.mp3";

onloadhaha();
}

function dream(){
img.src = "/homestuck/old/hscrop/dreamjade.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/dreamjadebg.gif)";
bgstyle.backgroundPosition = "center bottom";
audio.src = "/homestuck/old/audio/balladofawakening.mp3";
...
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/jadebg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "";
}