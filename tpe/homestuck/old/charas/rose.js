...
function pregame(){
img.src = "/homestuck/old/hscrop/pregamerose.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/pregamerosebg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "/homestuck/old/audio/aggrieveviolin.mp3";

onloadhaha();
}

function dream(){
img.src = "/homestuck/old/hscrop/dreamrose.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/rosedersebg.gif)";
bgstyle.backgroundPosition = "center bottom";
audio.src = "/homestuck/old/audio/dersedreamers.mp3";

onloadhaha();
}

function firstalc(){
img.src = "/homestuck/old/hscrop/rosealcsesh.gif";
div.style = "display: inline;";
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/lolar.gif)";
bgstyle.backgroundPosition = "center center";
audio.src = "/homestuck/old/audio/thenewextreme.mp3"; //replace later probably?
onloadhaha();
}
...
bgstyle.backgroundImage = "url(/homestuck/old/hscrop/lalondebg.gif)";
bgstyle.backgroundPosition = "center top";
audio.src = "";
}