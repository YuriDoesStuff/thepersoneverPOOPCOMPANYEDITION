...
function naturetapes(){
 ...
 document.getElementById('para').innerHTML = '<span>insane, halarious, and the only time neil spouts profanity, this EP is the greatest thing to come from him. ever. save it for when you feel like shit <br> it uses a cardboard case. i don&apos;t really like that :(<br><br> 10/10 - favorite track: my trains</span>'; 
}
...
function goodbye4track(){
 ...
 document.getElementById('para').innerHTML = '<span>this is such a silly album oh my god :3 <br> if you&apos;re having a bad day, give this album a listen!!! it has tons of soundbytes, irreverant lyrics, and a cozy texture to each song <br><br> 8/10 - favorite track: do the confusion!</span>'; 
}
...
function normalalbum(){
 ...
 document.getElementById('para').innerHTML = '<span> -- bought digitally -- <br><br> this album is great it starts off with william jimmy tapeworm being mad and ends with him being glad his impact on the universe is negligable you <br> should go listen to it <br> also the instrumentals are varied and all great :D <br><br> 8/10 - favorite track: MARTHA THANKKYOU OFR THE MEDICINE</span>'; 
}
